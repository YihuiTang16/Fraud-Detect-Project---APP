...
st.caption("Beneish M-Score and logistic regression results for each company in the dataset.")
st.markdown("---")
...
with col_left:
    ...
    if row["scandal"]:
        st.info(f"**Enforcement action:** {row['scandal']}")
...
st.caption("Absolute coefficient magnitude indicates each ratio's contribution to the model's prediction.")
